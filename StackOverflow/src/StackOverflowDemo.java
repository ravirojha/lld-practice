...
public class StackOverflowDemo {
    public static void main(String[] args) {
        ...
        system.voteQuestion(charlie, javaQuestion);  // Upvote
        system.voteAnswer(charlie, bobAnswer);  // Upvote
        ...
        system.voteQuestion(charlie, pythonQuestion);  // Upvote
        system.voteAnswer(charlie, aliceAnswer);  // Upvote

        // Print out the current state
        System.out.println("Question: " + javaQuestion.getTitle());
        System.out.println("Asked by: " + javaQuestion.getAuthor().getName());
        System.out.println("Tags: " + javaQuestion.getTags().stream().map(Tag::getTagContent).reduce((a, b) -> a + ", " + b).orElse(""));
        System.out.println("Votes: " + javaQuestion.getVotes().size());
        ...
        System.out.println("Votes: " + bobAnswer.getVotes().size());
